...
export const Header: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Drawer */}
      <div className={`fixed inset-0 z-[60] transform transition-transform duration-500 ease-in-out ${mobileOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="absolute inset-0 bg-forest/50" onClick={() => setMobileOpen(false)} />
        <div className="absolute top-0 right-0 bottom-0 w-full max-w-sm bg-cream p-8 shadow-2xl overflow-y-auto">
